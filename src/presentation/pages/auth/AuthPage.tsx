...
export function AuthPage() {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => navigate({ to: '/client' }), 1400);
  };
    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="flex flex-col px-6 sm:px-10 lg:px-16 py-8 relative">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-md w-full mx-auto py-10">
          <Link to="/client" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground mb-6">
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-4">
            ...
            <button type="submit"
              className="w-full h-11 inline-flex items-center justify-center gap-2 rounded-lg bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity">
