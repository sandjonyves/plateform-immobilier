import { FileSearch, Home, Map, Ruler, FileCheck2, Compass, Banknote, HardHat, ShieldCheck } from 'lucide-react';
...
export const services: Service[] = [
  ...
  },
  {
    ...
    details: ['Terrains titrés', 'Visualisation ', 'Accompagnement notarial', 'Financement possible'],
