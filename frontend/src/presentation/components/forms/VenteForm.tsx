...
export function VenteForm({ open, onClose }: { open: boolean; onClose: () => void }) {
  const ajouter = useVenteStore((s) => s.ajouter);
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await ajouter({
        type: 'vente', bien_id: bienId, bien_type: bienType,
  ...
  return (
    <Modal open={open} onClose={onClose} titre="Nouvelle vente" sous_titre="Vente d'un terrain ou d'une maison" size="md">
